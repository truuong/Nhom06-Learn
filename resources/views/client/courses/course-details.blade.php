                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <ul>
                                    ...
                                    <li>Export production ready /assets-client.</li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="course-card">
                            ...
                            <div id="collapseOne" class="card-collapse collapse" style>
                                <ul>
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture1.1
                                    ...
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture1.2
                                    ...
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture1.3 How
                                            to solve the previous exercise</p>
                                        <div>
                                            <a href="javascript:void(0);">Preview</a>
                                            <span>02:53</span>
                                        </div>
                                    ...
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture1.5 How
                                            to use text layers effectively</p>
                                        <div>
                                            <a href="javascript:void(0);">Preview</a>
                                            <span>02:53</span>
                                        </div>
                        ...
                        <div class="course-card">
                            ...
                            <div id="coursefour" class="card-collapse collapse" style>
                                <ul>
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture4.1
                                            Introduction to the User Experience Course</p>
                                        <div>
                                            <a href="javascript:void(0);">Preview</a>
                                            <span>02:53</span>
                                    ...
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture4.2
                                            Exercise: Your first design challenge</p>
                                        <div>
                                            <a href="javascript:void(0);">Preview</a>
                                            <span>02:53</span>
                                    ...
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture4.3 How
                                            to solve the previous exercise</p>
                                        <div>
                                            <a href="javascript:void(0);">Preview</a>
                                            <span>02:53</span>
                                    ...
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture4.4 How
                                            to solve the previous exercise</p>
                                        <div>
                                            <a href="javascript:void(0);">Preview</a>
                                            <span>02:53</span>
                                    ...
                                    <li>
                                        <p><img src="/assets-client/img/icon/play.svg" alt class="me-2">Lecture4.5 How
                                            to use text layers effectively</p>
                                        <div>
                                            <a href="javascript:void(0);">Preview</a>
                                            <span>02:53</span>
                ...
                <div class="sidebar-sec">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a href="https://www.youtube.com/embed/1trvO6dqQUI" class="video-thumbnail"
                                    ...
                                    <img class src="/assets-client/img/video.jpg" alt>
                                </a>
                    ...
                    <div class="card include-sec">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><img src="/assets-client/img/icon/import.svg" class="me-2" alt> 11 hours on-demand
                                    video</li>
                                <li><img src="/assets-client/img/icon/play.svg" class="me-2" alt> 69 downloadable
                                    resources</li>
                                <li><img src="/assets-client/img/icon/key.svg" class="me-2" alt> Full lifetime access
                                </li>
                                <li><img src="/assets-client/img/icon/mobile.svg" class="me-2" alt> Access on mobile and
                                    TV</li>
                                <li><img src="/assets-client/img/icon/cloud.svg" class="me-2" alt> Assignments</li>
                                <li><img src="/assets-client/img/icon/teacher.svg" class="me-2" alt> Certificate of
                                    Completion</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card feature-sec">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><img src="/assets-client/img/icon/users.svg" class="me-2" alt> Enrolled: <span>32
                                        students</span></li>
                                <li><img src="/assets-client/img/icon/timer.svg" class="me-2" alt> Duration: <span>20
                                        hours</span></li>
                                <li><img src="/assets-client/img/icon/chapter.svg" class="me-2" alt> Chapters:
                                    <span>15</span></li>
                                <li><img src="/assets-client/img/icon/video.svg" class="me-2" alt> Video:<span> 12
                                        hours</span></li>
                                <li><img src="/assets-client/img/icon/chart.svg" class="me-2" alt> Level:
