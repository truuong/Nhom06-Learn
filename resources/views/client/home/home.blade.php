            ...
            <div class="container">
                ...
                <div class="owl-carousel home-three-favourite-carousel owl-theme aos">
                    <div class="favourite-box" data-aos="fade-down">
                        <div class="favourite-item flex-fill">
                            <div class="categories-icon">
                                <img class="img-fluid" src="/assets-client/img/category/category-1.svg"
                                        ...
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title
                                                data-bs-original-title="leader 1"><img
                                                    src="/assets-client/img/profiles/avatar-01.jpg" alt="img"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title
                                                data-bs-original-title="leader 2"><img
                                                    src="/assets-client/img/profiles/avatar-02.jpg" alt="img"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title
                                                data-bs-original-title="leader 3"><img
                                                    src="/assets-client/img/profiles/avatar-03.jpg" alt="img"></a>
                                        </li>
                                        <li class="more-set">
                                            <a href="#">80+</a>
                                        </li>
                    ...
                    <div class="favourite-box" data-aos="fade-down">
                        <div class="favourite-item flex-fill">
                            <div class="categories-icon">
                                <img class="img-fluid" src="/assets-client/img/category/category-2.svg"
                    ...
                    <div class="favourite-box" data-aos="fade-down">
                        <div class="favourite-item flex-fill">
                            <div class="categories-icon">
                                <img class="img-fluid" src="/assets-client/img/category/category-3.svg"
                    ...
                    <div class="favourite-box" data-aos="fade-down">
                        <div class="favourite-item flex-fill">
                            <div class="categories-icon">
                                <img class="img-fluid" src="/assets-client/img/category/category-4.svg"
                                    alt="NODE JS Development">
                            </div>
                            <div class="categories-content course-info">
                                <h3>NODE JS Development</h3>
                    ...
                    <div class="favourite-box" data-aos="fade-down">
                        <div class="favourite-item flex-fill">
                            <div class="categories-icon">
                                <img class="img-fluid" src="/assets-client/img/category/category-5.svg"
                                    alt="Angular Development">
                            </div>
                            <div class="categories-content course-info">
                    ...
                    <div class="favourite-box" data-aos="fade-down">
                        <div class="favourite-item flex-fill">
                            <div class="categories-icon">
                                <img class="img-fluid" src="/assets-client/img/category/category-6.svg"
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                <div class="acheive-goals">
                    <div class="acheive-elips-one">
                        <img src="/assets-client/img/icon-three/ellipse-1.svg" alt>
                    </div>
    ...
    <div class="container">
        ...
        <div class="m-0 p-0 lead-group aos" data-aos="fade-up">
            <div class="lead-group-slider owl-carousel owl-theme">
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt src="/assets-client/img/lead-01.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt src="/assets-client/img/lead-02.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt src="/assets-client/img/lead-03.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt src="/assets-client/img/lead-04.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt src="/assets-client/img/lead-05.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt src="/assets-client/img/lead-06.png">
                    </div>
                </div>
            </div>
        </div>
...
<section class="testimonial-three">
    <div class="container">
        <div class="testimonial-pattern">
            <img class="pattern-left img-fluid" alt src="/assets-client/img/bg/pattern-05.svg">
            <img class="pattern-right img-fluid" alt src="/assets-client/img/bg/pattern-06.svg">
        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item-five">
                                    <div class="testimonial-quote">
                                        <img class="quote img-fluid" alt src="/assets-client/img/bg/quote.svg">
                                    </div>
                                    ...
                                    <div class="testimonial-users">
                                        <div class="imgbx">
                                            <img class="img-fluid" alt src="/assets-client/img/profiles/avatar-02.jpg">
                                        </div>
                                        <div class="d-block">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item-five">
                                    ...
                                    <div class="testimonial-users">
                                        <div class="imgbx">
                                            <img class alt src="/assets-client/img/profiles/avatar-01.jpg">
                                        </div>
                                        <div class="d-block">
                                            <h6>Martin Harn</h6>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item-five">
                                    ...
                                    <div class="testimonial-users">
                                        <div class="imgbx">
                                            <img class alt src="/assets-client/img/profiles/avatar-05.jpg">
                                        </div>
                                        <div class="d-block">
                                            <h6>Noah Aarons</h6>
                                            <p>Business Man</p>
