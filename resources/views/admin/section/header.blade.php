...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr" data-theme="theme-default" data-assets-path="/assets-admin/" data-template="vertical-menu-template">

  
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/app-logistics-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Mar 2024 06:57:26 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!-- Menu waves for no-customizr fix -->
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="{{ route('admin.Dashboard-admin') }}" class="menu-link">
            <div >HOME</div>
          </a>
        </li>
      </ul>
